...
const Confirmation: React.FC = () => {
  ...
  const getSessionTypeDetails = () => {
    switch (appointmentData.sessionType) {
      case 'in-person':
        return 'Please arrive 15 minutes early for check-in. Our clinic is located at 123 Medical Center Drive, Healthcare City, HC 12345.';
      case 'video':
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden max-w-2xl mx-auto">
      ...
      <div className="p-6">
        ...
        {appointmentData.emailStatus && (
          <div className="mb-6">
            {appointmentData.emailStatus.clientEmailSent ? (
              <div className="flex items-center p-3 bg-green-50 border border-green-200 rounded-lg">
                <Mail className="h-5 w-5 text-green-500 mr-2" />
                <span className="text-sm text-green-700">
                  Confirmation email sent successfully to {appointmentData.clientEmail}
                </span>
              </div>
            ) : (
              <div className="flex items-center p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <span className="text-sm text-yellow-700">
                  There was an issue sending the confirmation email. Please save this confirmation page for your records.
                </span>
              </div>
            )}
          </div>
        ...
        <div className="bg-blue-50 rounded-lg p-4 mb-6">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            ...
            {/* <li>• Please bring a valid ID and insurance card to your appointment</li> */}
          </ul>
        </div>
